"""Cria workflow n8n para nudge de reativação diário às 14h BRT."""
import json
...
workflow = {
    "name": "ATLAS \u2014 Reativa\u00e7\u00e3o Inativos (14h)",
    "nodes": [
        {
            "parameters": {
                "rule": {
        ...
        {
            "parameters": {
                "url": "https://atlas-m3wb.onrender.com/v1/reactivation/nudge",
                "options": {}
            },
            "name": "GET Nudge Reativa\u00e7\u00e3o",
    ...
    "connections": {
        "Cron Di\u00e1rio 14h BRT": {
            "main": [[{"node": "GET Nudge Reativa\u00e7\u00e3o", "type": "main", "index": 0}]]
        },
        "GET Nudge Reativa\u00e7\u00e3o": {
            "main": [[{"node": "Tem inativos?", "type": "main", "index": 0}]]
        },
        "Tem inativos?": {
            "main": [
                [{"node": "Dividir Mensagens", "type": "main", "index": 0}],
                [{"node": "Ningu\u00e9m inativo (Parar)", "type": "main", "index": 0}]
            ]
        },
        "Dividir Mensagens": {
